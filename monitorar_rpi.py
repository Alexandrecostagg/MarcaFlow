        ...
        if tracked:
            ...
            for dispatch in element.findall("./despachos/despacho"):
                ...
                movement = {
                    ...
                    "flowStage": tracked.get("flowStage", ""),
                    "owner": tracked.get("owner", ""),
                    "previousAction": tracked.get("nextAction", ""),
...
def markdown(report: dict) -> str:
    ...
    for item in report["movements"]:
        lines += [
            ...
            "",
            f"- Cliente: {item.get('client') or 'Nao informado'}",
            f"- Etapa atual: {item.get('flowStage') or 'Nao informada'}",
